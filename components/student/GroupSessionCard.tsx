...
import { joinGroupSession, leaveGroupSession, type StudentGroupSession } from '@/app/university/actions/group-sessions'
    ...
    return (
        <div className="mt-2">
            <div className="flex justify-between text-xs mb-1">
                ...
                <span className={remaining <= 3 ? 'text-red-600 font-semibold' : 'text-gray-500'}>
                    {remaining > 0 ? `${remaining} remaining${remaining <= 3 ? ' — almost full!' : ''}` : 'Full'}
                </span>
            </div>
