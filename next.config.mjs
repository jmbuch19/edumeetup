                ...
                headers: [
                    ...
                    },
                    {
                        ...
                        value: [
                            ...
                            "connect-src 'self' https://*.neon.tech https://api.resend.com https://o4511006401691648.ingest.us.sentry.io https://*.clare.ai https://*.wati.io https://wati-integration-prod-service.clare.ai https://static.cloudflareinsights.com",
                            "media-src 'self'",
                            "object-src 'none'",
