        ...
        return [
            {
                ...
                headers: [
                    ...
                    },
                    {
                        ...
                        value: [
                            "default-src 'self'",
                            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.clare.ai https://*.wati.io https://static.cloudflareinsights.com",
                            ...
                            "connect-src 'self' https://*.neon.tech https://api.resend.com https://o4511006401691648.ingest.us.sentry.io https://*.clare.ai https://*.wati.io https://wati-integration-prod-service.clare.ai https://static.cloudflareinsights.com https://api.whereby.dev",
                            "media-src 'self'",
                            "object-src 'none'",
                            "frame-src 'self' https://*.clare.ai https://*.wati.io https://*.whereby.com",
