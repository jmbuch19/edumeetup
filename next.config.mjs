        ...
        return [
            {
                ...
                headers: [
                    ...
                    },
                    {
                        ...
                        value: [
                            "default-src 'self'",
                            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://wati-integration-prod-service.clare.ai",
                            ...
                            "font-src 'self' data:",
                            "connect-src 'self' https://*.neon.tech https://api.resend.com https://o4511006401691648.ingest.us.sentry.io https://*.clare.ai https://*.wati.io",
                            "media-src 'self'",
                            "object-src 'none'",
                            "frame-src 'none'",
