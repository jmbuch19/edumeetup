...
export default function UniversityDashboardError({
  error, reset
}: { error: Error & { digest?: string }, reset: () => void }) {
  useEffect(() => {
    console.error('[UniversityDashboard]', error)
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="glass-card rounded-2xl p-8 text-center max-w-sm w-full animate-pop">
        <Building2 className="w-12 h-12 text-[#C9A84C] mx-auto mb-4 animate-float" />
        ...
        <p className="font-jakarta text-sm text-[#888888] mb-5">
          Your university profile is safe. This section had a temporary issue.
        </p>
