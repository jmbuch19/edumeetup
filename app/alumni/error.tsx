...
export default function AlumniDashboardError({
  ...
  useEffect(() => {
    console.error('[AlumniDashboard]', error)
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="glass-card rounded-2xl p-8 text-center max-w-sm w-full animate-pop">
        <Users className="w-12 h-12 text-[#C9A84C] mx-auto mb-4 animate-float" />
        ...
        <p className="font-jakarta text-sm text-[#888888] mb-5">
          Your alumni profile is safe. This section had a temporary issue.
        </p>
