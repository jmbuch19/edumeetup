    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
            ...
            <div className="flex gap-4">
                ...
                <Button variant="secondary" onClick={() => window.open(`mailto:${process.env.NEXT_PUBLIC_SUPPORT_EMAIL ?? 'support@edumeetup.com'}?subject=Crash Report&body=Error: ${error.message}%0D%0ADigest: ${error.digest || 'N/A'}`, '_blank')}>
                    Report Issue
                </Button>
            </div>
        </div>
